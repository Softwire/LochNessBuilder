...
namespace Tests
{
    ...
    public class WithEnumerable_Tests
    {
        [Test]
        public void WithEnumerable_SetsAProperty()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ArrayProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_Array()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ArrayProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_List()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ListProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_Queue()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.QueueProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_Stack()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.StackProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_HashSet()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.HashSetProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_Collection()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.CollectionProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostFormsOfConcreteIEnumerable_ReadOnlyCollection()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ReadOnlyCollectionProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesAPureIEnumerable()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.IEnumerableProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostInterfacesDerivingFromIEnumerable_IQueryable()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.IQueryableProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostInterfacesDerivingFromIEnumerable_ICollection()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ICollectionProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostInterfacesDerivingFromIEnumerable_IList()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.IListProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostInterfacesDerivingFromIEnumerable_ISet()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ISetProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_PopulatesMostInterfacesDerivingFromIEnumerable_IReadOnlyCollection()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.IReadOnlyCollectionProp, 1, 2).Build();
        ...
        [Test]
        public void WithEnumerable_ThrowsASensibleErrorIfUnableToPopulateAConcreteIEnumerableProperty()
        {
            Action builderSetupAction = () => Builder<TestObject>.New.WithEnumerable(o => o.ConcurrentBagProp, 1, 2);
        ...
        [Test]
        public void WithEnumerable_ThrowsASensibleErrorIfUnableToPopulateAnIEnumerableInterfaceroperty()
        {
            Action builderSetupAction = () => Builder<TestObject>.New.WithEnumerable(o => o.IOrderedEnumerableProp, 1, 2);
            builderSetupAction.Should().Throw<NotSupportedException>()
                .WithMessage("From the Int32 values provided, the IEnumerable handler knows how to create Int32[], List<Int32>, HashSet<Int32>, Queue<Int32>, Collection<Int32>, ReadOnlyCollection<Int32>, or IQueryable<Int32>. Your property type can't be populated by any of those types, and is thus unsupported by this method. Please use a standard .With() call.*")
        ...
        [Test]
        public void WithEnumerable_HandlesPopulatingWithBiggerNumericTypes()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.LongListProp, 1, 2).Build();
            output.LongListProp.Should().BeOfType<List<long>>();
        }

        [Test]
        public void WithEnumerable_HandlesPopulatingWithBiggerObjectTypes()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.ObjectListProp, new TestSubObject(), new TestSubObject()).Build();
            output.ObjectListProp.Should().BeOfType<List<object>>();
        }

        [Test]
        public void WithEnumerable_ForcesCastingToSmallerNumericTypes()
        {
            var output = Builder<TestObject>.New.WithEnumerable<short>(o => o.ShortListProp, 1, 2).Build();
            output.ShortListProp.Should().BeOfType<List<short>>();
        }

        [Test]
        public void WithEnumerable_ThrowsClearErrorWhenPopulatingWithSmallerObjectTypes()
        {
            Action builderSetupAction = () => Builder<TestObject>.New.WithEnumerable(o => o.SubObjectListProp, new object(), new object());
            builderSetupAction.Should().Throw<NotSupportedException>()
        ...
        [Test]
        public void WithEnumerable_HandlesMixedTypeParams()
        {
            var output = Builder<TestObject>.New.WithEnumerable(o => o.LongListProp, 3, 4l, (short)2).Build();
            output.LongListProp.Should().BeOfType<List<long>>();
        }
    }
}